...
### 2. Why this change
* Publicacion inicial del modelo 3D del pie para revisiones de montaje y ajuste.

### 3. Change scope
* Exportacion inicial de geometria completa del pie.

### 4. Version type
* **Type:** Major
* **Justification:** Primera version publica del componente.

### 5. Expected impact
* Disponible para revisiones de interferencia y ensamblaje.
...
### 7. Exported files
* 01_Mechanical/CAD/HEMA_PIE-001_1.0.0.step

### 8. Next action
* Ejecutar checklist operativo y actualizar estado.

---

## Entry 03: Ankle v1.0.0
**Date:** 2026-05-13
**Author:** Martin Isla Escudero
**Subsystem:** Mechanical / Ankle
**Part ID:** ANK-001
...
### 2. Why this change
* Publicacion inicial del modelo 3D del conjunto de tobillo para validacion de geometria.

### 3. Change scope
* Exportacion inicial del housing y geometria de montaje del tobillo.
...
### 5. Expected impact
* Disponible para revisar ajuste con la tibia y el pie.
...
### 7. Exported files
* 01_Mechanical/CAD/HEMA_ANK-001_1.0.0.step
